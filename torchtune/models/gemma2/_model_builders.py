...
def gemma2_9b() -> GemmaTransformerDecoder:
    """
...
def gemma2_27b() -> GemmaTransformerDecoder:
    """
    Builder for creating a Gemma 2B model initialized w/ the default 2b parameter values
    from: https://blog.google/technology/developers/gemma-open-models/
    ...
    return gemma2(
        ...
        attn_logit_softcapping=50.0,
        slidding_window_size=4096,
        attn_types=['LOCAL_SLIDING', 'GLOBAL'] * 23,
        norm_eps=1e-6,
    )
...
qlora_gemma_7b = partial(lora_gemma2_7b, quantize_base=True)
